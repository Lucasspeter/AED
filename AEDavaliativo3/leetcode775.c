...
bool isIdealPermutation( int *nums, int numsSize ) {
	...
	//pensei em mudar a funcao de inserir para guardar quantos eu inseri de cada lado mas nao deu certo
	//tambem pensei em percorrer o vetor ao contrario mas tambem nao foi
